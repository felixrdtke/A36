...
C {ADC/analogbuffer/analogbuffer.sym} 170 -20 0 0 {name=x1}
...
*---Save transient OP---
.save @m.x1.x1.xm2n.m0[gm]
.save @m.x1.x1.xm5n.m0[gds]
...
setplot dc1
plot vout-vin
plot @m.x1.x1.XM4PS.m0[id]
+ @m.x1.x1.XM5ns.m0[id]
+ @m.x1.x1.XM4ns.m0[id]
*plot @m.x1.x1.XM5P.m0[id]+@m.x1.x1.xm5pr.m0[id]
*+ @m.x1.x1.XM5n.m0[id]+@m.x1.x1.xm5nr.m0[id]
*plot 10*@m.x1.x1.xm2n.m0[gm]/@m.x1.x1.xm5n.m0[gds]
