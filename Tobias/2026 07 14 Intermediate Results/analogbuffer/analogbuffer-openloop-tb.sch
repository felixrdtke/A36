...
C {vsource.sym} 170 -200 0 0 {name=V1 value="dc \{vcm\} ac 1" savecurrent=false}
...
C {isource.sym} 420 -370 0 0 {name=I0 value=10u}
C {gnd.sym} 420 -420 2 0 {name=l1 lab=0}
C {lab_wire.sym} 390 -330 0 0 {name=p2 sig_type=std_logic lab=vdd}
