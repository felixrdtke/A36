...
N -160 -10 -160 10 {lab=vdd}
N -160 70 -160 90 {lab=0}
N 70 20 70 40 {lab=0}
...
C {vsource.sym} -160 40 0 0 {name=V1 value=3.3 savecurrent=false}
C {gnd.sym} -160 90 0 0 {name=l2 lab=0}
C {gnd.sym} 70 40 0 0 {name=l3 lab=0}
C {lab_wire.sym} -160 -10 0 0 {name=p1 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 70 -80 0 0 {name=p2 sig_type=std_logic lab=vdd}
C {vsource.sym} -40 30 0 0 {name=V2 value=3.3 savecurrent=false}
